...
public class ItemGenerator
{
    public static List<InventoryItem> GenerateRandomItems()
    {
        ...
        new InventoryItem { Item = new Pony { Name = "astarius", Age = 5, Color = "White", Price = new Price(10) } };
        new InventoryItem { Item = new Pony { Name = "Bathezar", Age = 7, Color = "Brown", Price = new Price(15) } };
